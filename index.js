...
// const LocalFileExtractor = require('./modules/local-file-extractor'); // Temporarily disabled
...
client.player.extractors.loadMulti(DefaultExtractors).then(async () => {
  ...
  // client.player.extractors.register(LocalFileExtractor); // Temporarily disabled
